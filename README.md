...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a984a5a8-d48f-42c1-b9c4-614265dcf964
```

> `a984a5a8-d48f-42c1-b9c4-614265dcf964` is the password of the certificate, you can change it to any password you want.
